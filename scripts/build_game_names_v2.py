"""合并外部翻译数据 + 手动映射，生成最终 game_names.json"""
import pandas as pd
import json
import sys
import re
...
# ============ 第二步：加载手动映射（build_game_names.py 里硬编码的） ============
# 直接执行 build_game_names.py 中的 MANUAL_NAMES 字典
MANUAL_NAMES = {
    ...
    "1017": {"schinese": "半条命：持续 privile", "japanese": "Half-Life: Opposing Force"},
    ...
    "26800": {"schinese": "火星重启", "japanese": "The Red Solstice"},
    ...
    "8190": {"schinese": "GTR 2", "japanese": "GTR 2 FIA GT Racing Game"},
    "8920": {"schinese": "圣歌", "japanese": "Sid Meier's Pirates!"},
    ...
    "107410": {"schinese": "地下城守护者", "japanese": "Dungeon of the Endless"},
    ...
    "12250": {"schinese": "生化危机 5", "japanese": "BIOHAZARD 5"},
    ...
    "230410": {"schinese": "战争框架", "japanese": "Warframe"},
    ...
    "244210": {"schinese": "不依赖", "japanese": "Noita"},
    "24980": {"schinese": "陨石猎人", "japanese": "Space Rangers"},
    ...
    "289070": {"schinese": "黑暗之魂：原罪学者", "japanese": "DARK SOULS II Scholar of the First Sin"},
    "292030": {"schinese": "黑暗之魂 3", "japanese": "DARK SOULS III"},
    "292410": {"schinese": "街头赛车", "japanese": "Street Racing Syndicate"},
    "311210": {"schinese": "饥荒", "japanese": "Don't Starve Together"},
    ...
    "324680": {"schinese": "不可能的生物 Steam版", "japanese": "Impossible Creatures Steam Edition"},
    ...
    "377160": {"schinese": "虚空巴纳德", "japanese": "Hollow Knight"},
    "3810": {"schinese": "古墓丽影：地下世界", "japanese": "Tomb Raider: Underworld"},
    ...
    "431960": {"schinese": "Wallpaper Engine", "japanese": "Wallpaper Engine"},
    ...
    "570": {"schinese": "刀塔 2", "japanese": "Dota 2"},
    "578080": {"schinese": "绝地求生", "japanese": "PLAYERUNKNOWN'S BATTLEGROUNDS"},
    "594650": {"schinese": "猎天使魔女 2", "japanese": "BAYONETTA 2"},
    "632470": {"schinese": "绝地求生", "japanese": "PLAYERUNKNOWN'S BATTLEGROUNDS"},
    "72850": {"schinese": "上古卷轴 V：天际", "japanese": "The Elder Scrolls V: Skyrim"},
    ...
    "863550": {"schinese": "Blender", "japanese": "Blender"},
    "892970": {"schinese": "Valheim", "japanese": "Valheim: ヴァルヘイム"},
    "945360": {"schinese": "跨过我的尸体", "japanese": "Over my dead body"},
    ...
    "1196590": {"schinese": "死灵法师之冕", "japanese": "Crown of the Necromancer"},
    "1245620": {"schinese": "艾尔登法环", "japanese": "ELDEN RING"},
    "1255250": {"schinese": "怪物火车", "japanese": "Monster Train"},
    "1290000": {"schinese": "命运方舟", "japanese": "Lost Ark"},
    "1325650": {"schinese": "木筏求生", "japanese": "RAFT"},
    "1332010": {"schinese": "逸剑风云决", "japanese": "逸剑风云决"},
    "1466860": {"schinese": "浪人崛起", "japanese": "Ronin Rising"},
    "1486350": {"schinese": "Fable Anniversary", "japanese": "Fable Anniversary"},
    ...
    "1551360": {"schinese": "Forza 地平线 5", "japanese": "Forza Horizon 5"},
    "1580130": {"schinese": "NARAKA: BLADEPOINT", "japanese": "NARAKA: BLADEPOINT"},
    "1593500": {"schinese": "城市天际线 2", "japanese": "Cities: Skylines II"},
    "1599340": {"schinese": "死亡搁浅 导演剪辑版", "japanese": "DEATH STRANDING DIRECTOR'S CUT"},
    "1623730": {"schinese": "幻兽帕鲁", "japanese": "Palworld"},
    "1625080": {"schinese": "Combat Master", "japanese": "Combat Master"},
    "1677740": {"schinese": "暗黑破坏神 4", "japanese": "Diablo IV"},
    "1687950": {"schinese": "深海迷航", "japanese": "Subnautica"},
    "1730660": {"schinese": "Great Adventurer", "japanese": "Great Adventurer"},
    "1786370": {"schinese": "冬季之声", "japanese": "Seasons of Heaven"},
    "1794680": {"schinese": "黑神话：悟空", "japanese": "黒神話：悟空"},
    "1817190": {"schinese": "炉石传说", "japanese": "Hearthstone"},
    ...
    "1938090": {"schinese": "Call of Duty", "japanese": "Call of Duty"},
    ...
    "2142790": {"schinese": "Forspoken", "japanese": "Forspoken"},
    "217200": {"schinese": "百战天虫：末日浩劫", "japanese": "Worms Armageddon"},
    "22000": {"schinese": "兄弟会", "japanese": "Brotherhood"},
    ...
    "261570": {"schinese": "传送门骑士", "japanese": "Portal Knights"},
    "2670630": {"schinese": "Marvin's Memories", "japanese": "Marvin's Memories"},
    "282140": {"schinese": "最终幻想 13", "japanese": "ファイナルファンタジーXIII"},
    ...
    "289070": {"schinese": "黑暗之魂 2 原罪学者", "japanese": "DARK SOULS II Scholar of the First Sin"},
    "292030": {"schinese": "黑暗之魂 3", "japanese": "DARK SOULS III"},
    "324680": {"schinese": "不可能的生物", "japanese": "Impossible Creatures"},
    "359550": {"schinese": "彩虹六号：围攻 X", "japanese": "Tom Clancy's Rainbow Six Siege X"},
    "365670": {"schinese": "Blender", "japanese": "Blender"},
    "39000": {"schinese": "月球基地 Alpha", "japanese": "Moonbase Alpha"},
    "39680": {"schinese": "行会 2 文艺复兴", "japanese": "The Guild II Renaissance"},
    "400040": {"schinese": "ShareX", "japanese": "ShareX"},
    ...
    "945360": {"schinese": "尘骸魔境", "japanese": "Enshrouded"},
    "987130": {"schinese": "Stray", "japanese": "STRAY"},
    ...
    "1794680": {"schinese": "黑神话：悟空", "japanese": "黒神話：悟空"},
    "287700": {"schinese": "巫师 3：狂猎", "japanese": "ウィッチャー3 ワイルドハント"},
    "1096000": {"schinese": "命运方舟", "japanese": "ロストアーク"},
    "1325650": {"schinese": "木筏求生", "japanese": "RAFT"},
    "1503860": {"schinese": "怪物猎人：世界", "japanese": "モンスターハンター：ワールド"},
    "1493710": {"schinese": "战国无双 5", "japanese": "戦国無双5"},
    "2002100": {"schinese": "暗喻幻想", "japanese": "メタファー：リファンタジオ"},
    ...
    "2386460": {"schinese": "The Inheritance of Crimson Manor", "japanese": "The Inheritance of Crimson Manor"},
    "2358720": {"schinese": "漫威蜘蛛侠 重制版", "japanese": "Marvel's Spider-Man Remastered"},
    "1687950": {"schinese": "深海迷航", "japanese": "Subnautica"},
    ...
    "1929850": {"schinese": "第一后裔", "japanese": "The First Descendant"},
    "987130": {"schinese": "Stray", "japanese": "STRAY"},
    "1466860": {"schinese": "浪人崛起", "japanese": "Rise of the Ronin"},
    "2108330": {"schinese": "完蛋！我被美女包围了", "japanese": "完蛋！我被美女包围了"},
    "238690": {"schinese": "消逝的光芒", "japanese": "Dying Light"},
    "274190": {"schinese": "辐射 4", "japanese": "Fallout 4"},
    "289070": {"schinese": "黑暗之魂 2", "japanese": "DARK SOULS II"},
    "292030": {"schinese": "黑暗之魂 3", "japanese": "DARK SOULS III"},
    # 补充缺失的 69 个
    ...
    "1204050": {"schinese": "Pixel Studio - pixel art editor", "japanese": "Pixel Studio - pixel art editor"},
...
for appid, en_name in displayed.items():
    ...
    # 1. 优先用外部数据（25456条，更权威）
    result = try_ext_match(en_name)
    if result:
...
for _, row in df.iterrows():
    ...
    if appid_str in names:
        continue
    result = try_ext_match(str(row['name']))
    if result:
        names[appid_str] = result

print(f'页面显示的 {len(displayed)} 个游戏:')
print(f'  外部 CSV 匹配: {ext_match}')
